...
export default async function handler(req, res) {
  ...
  // Some connectors (e.g. Salesforce) store a numeric org ID rather than the
  // email-style account_id we pass, so if filtering yields 0 matches we fall
  // back to the full row set (the account_id param already scoped the request).
